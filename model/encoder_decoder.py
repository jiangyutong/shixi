...
class AutoEncoder(nn.Module):
    def __init__(self, bn=False, denis_activation=True):
        ...
        # self.b1_leaky_relu3 = nn.LeakyReLU(negative_slope=0.2, inplace=True)
        ...
        # self.b2_leaky_relu4 = nn.LeakyReLU(negative_slope=0.2, inplace=True)
        self.b2_relu4 = nn.ReLU()
        self.b2_deconv2 = nn.ConvTranspose2d(128, 64, 4, 2, padding=1)
        # self.b2_leaky_relu5 = nn.LeakyReLU(negative_slope=0.2, inplace=True)
    ...
    def forward(self, x):
        ...
        # heatmap = self.b2_relu6(self.b2_deconv3(heatmap))
